...
$kode = $kdbarang['kode_barang'] ?? null;

if ($kode !== null) {
	$urut = substr($kode, 8, 3);
	$tambah = (int) $urut + 1;
} else {
	$tambah = 1; // Mengatur urutan pertama jika tidak ada kode_barang sebelumnya
}
			...
			<div class="table-responsive">
				<div class="body">
					...
					if (isset($_POST['simpan'])) {
						...
						$sql = $koneksi->query("INSERT INTO gudang (kode_barang, nama_barang, jenis_barang_id, jumlah, satuan_id) VALUES ('$kode_barang', '$nama_barang', '$jenis_barang_id', '$jumlah', '$satuan_id')");
